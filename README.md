# Getting Started
## Дипломный проект:
### Программное средства совершенствования качества оказания таможенных услуг и программная поддержка процесса маркировки товаров (на примере РУП "Белтаможсервис")
## База данных 
### MySQL 
* username: root
* password: 4321
...
## Contact Information
### Email: parmo1977@gmai.com / mparmon@mail.ru
### Name: Parmon Maryia 
